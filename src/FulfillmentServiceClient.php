...
use Vendasta\Accounts\V1\internal\FulfillmentServiceGeneratedClient;

class FulfillmentServiceClient extends FulfillmentServiceGeneratedClient
{
    /**
     * FulfillmentServiceClient constructor.
